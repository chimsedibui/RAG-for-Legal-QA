...
embedder = OpenAIEmbeddingProvider(
    base_url=_settings.embedding.base_url,
    api_key=_settings.embedding.api_key,
    model_name=_settings.embedding.model_name,
)
...
def safe_embed(text):
    ...
    return normalize(np.array([vec], dtype=np.float32))[0]
